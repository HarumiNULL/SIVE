  ...
  return (
    <>
      ...
      <div className={styles.probability_container}>
        ...
        {openInfo && (
          <div className={styles.modal_overlay} onClick={() => setOpenInfo(null)}>
            <div className={styles.modal_content} onClick={e => e.stopPropagation()}>
              <button className={styles.close_btn} onClick={() => setOpenInfo(null)}>
                <X size={18} />
              </button>
              ...
              <p>
                {openInfo.info.split("https").length > 1 ? (
                  <>
                    ...
                    <a href={`https${openInfo.info.split("https")[1]}`} target="_blank" rel="noopener noreferrer">
